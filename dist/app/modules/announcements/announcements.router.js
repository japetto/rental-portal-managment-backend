...
router.get("/active", announcements_controller_1.AnnouncementController.getActiveAnnouncements);
router.get("/unread/:userId", (0, zodValidationRequest_1.default)(announcements_validation_1.AnnouncementValidation.getUnreadAnnouncementsValidationSchema), announcements_controller_1.AnnouncementController.getUnreadAnnouncements);
router.post("/mark-read", (0, zodValidationRequest_1.default)(announcements_validation_1.AnnouncementValidation.markAsReadValidationSchema), announcements_controller_1.AnnouncementController.markAsRead);
