...
const inviteTenant = inviteData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const property = yield properties_schema_1.Properties.findById(
    ...
    if (!spot) {
      throw new ApiError_1.default(
        http_status_1.default.NOT_FOUND,
        "Spot not found in this property",
      );
    }
    ...
    const existingSpotUser = yield users_schema_1.Users.findOne({
    ...
    yield spots_schema_1.Spots.findByIdAndUpdate(inviteData.spotId, {
      status: "MAINTENANCE",
    });
    // Property lots are now calculated from spots, no need to update manually
    const propertyWithLotData = yield (0,
    properties_service_1.addLotDataToProperty)(property);
    return {
      user,
...
const getAllProperties = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const properties = yield properties_schema_1.Properties.find({}).sort({
      createdAt: -1,
    });
    const propertiesWithLotData = yield (0,
    properties_service_1.addLotDataToProperties)(properties);
...
const updateProperty = (propertyId, updateData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(propertyId)) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
    ...
    const updatedProperty =
      yield properties_schema_1.Properties.findByIdAndUpdate(
        propertyId,
        updateData,
        { new: true, runValidators: true },
      );
    const propertyWithLotData = yield (0,
    properties_service_1.addLotDataToProperty)(updatedProperty);
    return propertyWithLotData;
  });
const deleteProperty = propertyId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tenantsCount = yield users_schema_1.Users.countDocuments({
      propertyId,
    });
    if (tenantsCount > 0) {
      throw new ApiError_1.default(
    ...
    const spotsCount = yield spots_schema_1.Spots.countDocuments({
      propertyId,
    });
    if (spotsCount > 0) {
      throw new ApiError_1.default(
...
const createSpot = spotData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const spot = yield spots_schema_1.Spots.create(
      Object.assign(Object.assign({}, spotData), {
...
const getSpotsByProperty = (propertyId, status) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(propertyId)) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
    ...
    const spots = yield spots_schema_1.Spots.find(query).sort({
      spotNumber: 1,
    });
    return spots;
  });
...
const updateSpot = (spotId, updateData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(spotId)) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
    ...
    const updatedSpot = yield spots_schema_1.Spots.findByIdAndUpdate(
      spotId,
      updateData,
      {
        new: true,
...
const deleteSpot = spotId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Check if spot is in reserved
    if (spot.status === "RESERVED") {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
        "Cannot delete a spot that is reserved",
      );
    }
...
const getAllServiceRequests = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const serviceRequests =
      yield service_requests_schema_1.ServiceRequests.find(filterConditions)
        .populate(
          "tenantId",
        ...
        .limit(limit);
    const total =
      yield service_requests_schema_1.ServiceRequests.countDocuments(
        filterConditions,
      );
    return {
      meta: {
...
const getServiceRequestById = requestId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const serviceRequest =
      yield service_requests_schema_1.ServiceRequests.findById(requestId)
        .populate(
          "tenantId",
          "name email phoneNumber profileImage bio preferredLocation emergencyContact",
        )
...
const updateServiceRequest = (requestId, updateData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedRequest =
      yield service_requests_schema_1.ServiceRequests.findByIdAndUpdate(
        requestId,
        updateData,
        { new: true, runValidators: true },
      )
...
const addAdminComment = (requestId, comment) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(requestId)) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
...
const getServiceRequestsByProperty = (propertyId, filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(propertyId)) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
...
const getServiceRequestsByTenant = (tenantId, filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getUrgentServiceRequests = options =>
  __awaiter(void 0, void 0, void 0, function* () {
    const page = options.page || 1;
    const limit = options.limit || 10;
    const skip = (page - 1) * limit;
...
const getServiceRequestDashboardStats = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const totalRequests =
      yield service_requests_schema_1.ServiceRequests.countDocuments();
...
const getUserById = (userId, adminId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user =
      yield users_schema_1.Users.findById(userId).select("-password");
    if (!user) {
      throw new ApiError_1.default(
        http_status_1.default.NOT_FOUND,
        "User not found",
...
const updateUser = (userId, updateData, adminId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(userId)) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
    ...
    const updatedUser = yield users_schema_1.Users.findByIdAndUpdate(
      userId,
      updateData,
      {
        new: true,
