...
const archiveServiceRequest = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const { id } = req.params;
    const userId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString();
    const userRole = (_c = req.user) === null || _c === void 0 ? void 0 : _c.role;
    ...
    const result = yield service_requests_service_1.ServiceRequestService.archiveServiceRequest(id, userId, userRole || "");
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: result.message,
...
const restoreServiceRequest = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const { id } = req.params;
    const userId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString();
    const userRole = (_c = req.user) === null || _c === void 0 ? void 0 : _c.role;
    ...
    const result = yield service_requests_service_1.ServiceRequestService.restoreServiceRequest(id, userId, userRole || "");
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: result.message,
...
const getArchivedServiceRequests = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const userId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString();
    const userRole = (_c = req.user) === null || _c === void 0 ? void 0 : _c.role;
    if (!userId) {
    ...
    const options = {
        ...
        sortBy: req.query.sortBy || "deletedAt",
        sortOrder: req.query.sortOrder || "desc",
    };
    const result = yield service_requests_service_1.ServiceRequestService.getArchivedServiceRequests(userId, userRole || "", filters, options);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
